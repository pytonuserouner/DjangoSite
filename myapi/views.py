...
def profile(request):
    if request.method == "GET":
        data = {
            "fullName": User.objects.get("fullName"),  #"Annoying Orange",
            "email": User.objects.get("email"),  # "no-reply@mail.ru",
            "phone": User.objects.get("phone"),  # "88002000600",
            "avatar": {
                "src": User.objects.get("src"),
                "alt": User.objects.get("hello alt")  # "hello alt",
            },
        }
